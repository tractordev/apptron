/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0752290889d977c3619d0d05c5c7d42c)
// Runtime types generated with workerd@1.20250917.0 2025-08-21 
declare namespace Cloudflare {
	...
	interface Env {
		CF_ACCOUNTID: string;
		CF_ACCESSKEYID: string;
		CF_ACCESSKEYSECRET: string;
		session: DurableObjectNamespace<import("./worker").Session>;
		bucket: R2Bucket;
		assets: Fetcher;
	}
}
